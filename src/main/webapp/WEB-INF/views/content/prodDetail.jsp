...
<body>
            ...
            <main class="cont">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item"><span class="info-label">생산시작일</span><span class="info-value">${prodDTO.plan_start}</span></div>
                    <div class="info-item"><span class="info-label">생산마감일</span><span class="info-value">${prodDTO.plan_end}</span></div>
                    <div class="info-item"><span class="info-label">등록일</span><span class="info-value">${prodDTO.created_at}</span></div>
                </div>

                <!-- 2. 생산 진행 현황 -->
                <div class="section-title">■ 생산 진행 현황</div>
                <div class="status-grid">
                    <div class="status-card"><div class="info-label">계획 수량</div><div class="status-num">${prodDTO.plan_qty} EA</div></div>
                    <div class="status-card"><div class="info-label" style="color: var(--s-cl);">생산 완료</div><div class="status-num" style="color: var(--s-cl);">${prodDTO.currentqty} EA</div></div>
                    <div class="status-card"><div class="info-label">잔여 수량</div><div class="status-num">${prodDTO.plan_qty - prodDTO.currentqty < 0 ? 0 : prodDTO.plan_qty - prodDTO.currentqty} EA</div></div>
