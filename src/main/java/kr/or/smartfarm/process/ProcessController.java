...
public class ProcessController {
	...
	public String Detail(@RequestParam(value="process_num", required=false) int Num, Model model) {
	    ...
	    if (result != null && !result.isEmpty()) {
	        String uploadPath = "D:\\\\potato\\\\proj03\\\\src\\\\main\\\\webapp\\\\WEB-INF\\\\views\\\\processImg\\\\";
	...
	System.out.println(searchMap);
		...
		public String insertController(ProcessDTO dto, Model model) {
			String uploadFolder = "D:/potato/proj03/src/main/webapp/WEB-INF/views/processImg";
